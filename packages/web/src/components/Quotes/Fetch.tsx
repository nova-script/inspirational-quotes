...
import type { HomeAllQuotesQuery as HomeAllQuotesQueryType } from "../../pages/__generated__/HomeAllQuotesQuery.graphql";
...
export default function FetchQuotes(props: QuotesProps): JSX.Element {
  ...
  return quotesQueryReference != null ? (
    <RenderQuotes refresh={refresh} queryReference={quotesQueryReference} />
  ) : (
    <></>
  );
}
